...
class VolumeSlider_LF : public juce::LookAndFeel_V4
{
public:
        ...
        const juce::Slider::SliderStyle style, juce::Slider& slider) override
    {
        ...
        */
        ...
        if (style == juce::Slider::LinearVertical)
        {
            ...
            else if (neutralPos - adjustedSliderPos < 0)
            {
                g.setColour(trackColor);
                g.fillRect(trackLeft, neutralPos, trackWidth, adjustedSliderPos - neutralPos);
            }


            // Draw the thumb/fader
            float thumbWidth = width * 0.075f;
