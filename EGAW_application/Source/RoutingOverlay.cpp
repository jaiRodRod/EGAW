...
//==============================================================================
RoutingOverlay::RoutingOverlay() : hotspot(16,16), customCursor(customCursorImage, hotspot.x, hotspot.y)
{
...
void RoutingOverlay::mouseEnter(const juce::MouseEvent& event)
{
