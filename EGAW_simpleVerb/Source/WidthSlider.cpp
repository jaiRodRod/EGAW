...
WidthSlider::WidthSlider() : juce::Slider(SliderStyle::RotaryHorizontalVerticalDrag, TextEntryBoxPosition::TextBoxBelow), isTextActive(false)
{
...
void WidthSlider::paint(juce::Graphics& g)
{
...
void WidthSlider::setDataMode(bool shouldBeOn)
{
    if (shouldBeOn)
    {
...
void WidthSlider::mouseDrag(const juce::MouseEvent& event)
{
    setMouseCursor(juce::MouseCursor::DraggingHandCursor);
    juce::Slider::mouseDrag(event);
}

void WidthSlider::mouseDoubleClick(const juce::MouseEvent& event)
{
    setValue(0.0f);
    juce::Slider::mouseDoubleClick(event);
}

void WidthSlider::mouseWheelMove(const juce::MouseEvent& event, const juce::MouseWheelDetails& wheel)
{
    juce::Slider::mouseWheelMove(event, wheel);
}

void WidthSlider::mouseDown(const juce::MouseEvent& event)
{
...
void WidthSlider::mouseUp(const juce::MouseEvent& event)
{
