...
DampingSlider::DampingSlider() : juce::Slider(SliderStyle::RotaryHorizontalVerticalDrag, TextEntryBoxPosition::TextBoxBelow), isTextActive(false)
{
...
void DampingSlider::paint(juce::Graphics& g)
{
...
void DampingSlider::setDataMode(bool shouldBeOn)
{
    if (shouldBeOn)
    {
...
void DampingSlider::mouseDrag(const juce::MouseEvent& event)
{
    setMouseCursor(juce::MouseCursor::DraggingHandCursor);
    juce::Slider::mouseDrag(event);
}

void DampingSlider::mouseDoubleClick(const juce::MouseEvent& event)
{
    setValue(0.0f);
    juce::Slider::mouseDoubleClick(event);
}

void DampingSlider::mouseWheelMove(const juce::MouseEvent& event, const juce::MouseWheelDetails& wheel)
{
    juce::Slider::mouseWheelMove(event, wheel);
}

void DampingSlider::mouseDown(const juce::MouseEvent& event)
{
...
void DampingSlider::mouseUp(const juce::MouseEvent& event)
{
